  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (products.error || categories.error) {
        throw new Error("An Error ocurred while fetching data");
      }
...
export const getMyOrders = () => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (error) {
        throw new Error(
          "An Error occured when fetching orders:" + error.message
        );
      }
...
export const createOrderItem = () => {
  return useMutation({
    async mutationFn(
      ...
      if (error) {
        throw new Error(
          "An Error Occured when creating order item:" + error.message
        );
      }
...
export const getMyOrder = (slug: string) => {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      if (error || !data) {
        throw new Error("An Error occured when fetching data:" + error.message);
      }
